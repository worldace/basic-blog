...
//■非公開記事
// 
// http://127.0.0.1/basic-blog/?action=tool&tool=privatelist
// 呼び出し元: ../tool.php
//======================================================
...
$設定['ページめくり']       = 部品("paging", $_GET['page'], $設定['ライトインデックス記事表示件数'], count($検索結果), "{$設定['URL']}?action=tool&tool=privatelist&page=");
